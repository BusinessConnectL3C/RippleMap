    ...
    const { error } = await client.emails.send({
      ...
      html: `
        <div style="font-family: -apple-system, sans-serif; max-width: 480px; margin: 0 auto;">
          <div style="background: #1B4F72; height: 4px; border-radius: 2px; margin-bottom: 24px;"></div>
          <h2 style="color: #111827;">You've been invited to RippleMap</h2>
          ...
          <p style="margin: 24px 0;">
            <a href="${params.inviteUrl}"
               style="background: #1B4F72; color: #fff; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: 500; font-size: 14px;">
              Accept invite
            </a>
          </p>
